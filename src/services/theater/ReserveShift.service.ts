    ...
    try {
      await sendEmail(
        ...
        <body>
            ...
            <p>Lamentamos informarle que su reserva en <strong>El Juvenil Multiespacio</strong> ha sido cancelada con éxito.</p>
            
            <p>Detalles del pedido cancelado:</p>
            <ul>
                <li>Fecha de la reserva: <strong>[Fecha de la Reserva]</strong></li>
                <li>Nombre del cliente: <strong>${client.name}</strong></li>
                <li>Sala reservada: <strong>[Nombre de la Sala]</strong></li>
                <li>Fecha de llegada: <strong>[Fecha de Llegada]</strong></li>
                <li>Fecha de salida: <strong>[Fecha de Salida]</strong></li>
            </ul>
        
            <p>Si tiene alguna pregunta o necesita más asistencia, no dude en ponerse en contacto con nosotros.</p>
            
            <p>Lamentamos cualquier inconveniente causado y esperamos tener la oportunidad de darle la bienvenida en el futuro.</p>
