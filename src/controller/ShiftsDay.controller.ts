...
export class ShiftsDayController {
  ...
  async updateShiftDay(req: Request, res: Response) {
    try {
      ...
      const shiftsDay = await shiftDayService.updateShifsDay(
        idRoom,
        idShiftsDay,
        body
      );
  ...
  async deleteShiftDay(req: Request, res: Response) {
    try {
      ...
      const shiftsDay = await shiftDayService.deleteShiftsDay(
        idRoom,
        idShiftsDay
      );
  ...
  async findShiftDayById(req: Request, res: Response) {
    try {
      ...
      const shiftsDay = await shiftDayService.findShiftsDayById(
        idRoom,
        idShiftsDay
      );
      const respH = new ResponseHandler<IShiftsDay>();
