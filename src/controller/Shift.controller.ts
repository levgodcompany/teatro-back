...
export class ShiftController {
    ...
    async updateShift(req: Request, res: Response) {
        try {
          ...
          const shift = await shiftService.updateShift(idRoom, idShiftsDay, idShift, body)
          const respH = new ResponseHandler<IShift>();
          respH.parseJson(shift);
          respH.respoensHandler(res, HttpStatus.OK);
        } catch (error) {
    ...
    async deleteShift(req: Request, res: Response) {
        try {
          ...
          const shift = await shiftService.deleteShift(idRoom, idShiftsDay, idShift)
    ...
    async findShiftById(req: Request, res: Response) {
        try {
          ...
          const shift = await shiftService.findShifsById(idRoom, idShiftsDay, idShift)
          const respH = new ResponseHandler<IShift>();
          respH.parseJson(shift);
          respH.respoensHandler(res, HttpStatus.OK);
        } catch (error) {
